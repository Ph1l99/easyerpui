...
const EASY_ERP_ARTICLE_URL = EASY_ERP_ARTICLES_URL + '/{ARTICLE_BARCODE}';
...
const EASY_ERP_TRANSACTION_DETAILS_URL =
    EASY_ERP_TRANSACTIONS_URL + '/{TRANSACTION_ID}/details';
const EASY_ERP_TRANSACTION_CREATE_URL = EASY_ERP_TRANSACTIONS_URL + '/-1';

// Repairs
const EASY_ERP_REPAIRS_URL = EASY_ERP_REPAIRS_BASE_URL + '/';
const EASY_ERP_REPAIR_URL = EASY_ERP_REPAIRS_BASE_URL + '/{REPAIR_BARCODE}';
...
export {
    ...
    EASY_ERP_TRANSACTION_DETAILS_URL,
    EASY_ERP_TRANSACTION_CREATE_URL,
